...
function goToMarkAttendance() {
  window.location.href = "staff-mark-attendance.html";
}
function goToAttendanceRecords() {
  window.location.href = "staff-attendance-records.html";
}
function goToUserManagement() {
  window.location.href = "staff-user-management.html";
}
...
document.getElementById("staffName").textContent =
  sessionStorage.getItem("name") || "Staff";
...
let tempPhoto = null;
let savedPhotoUrl = localStorage.getItem("staffProfilePhoto");
...
if (saveBtn) {
  saveBtn.addEventListener("click", () => {
    if (!tempPhoto) return;
    localStorage.setItem("staffProfilePhoto", tempPhoto);
